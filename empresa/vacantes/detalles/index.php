...
<div class="container" id="tarjetavacante" style="background-image: url('imagenes_vacantes/<?php echo $oferta['ID']; ?>/<?php echo $img; ?>'); background-repeat: no-repeat; background-size: cover; margin-top:-5%;">
    ...
    <div id="btnpc" style="margin-top: -30%; color: aqua; z-index: 2; text-align: right;">
        ...
        <div class="row">
            <div class="col-10"></div>
            <div class="col-2">
                <button class="btn btn-outline-primary" style="font-size: 20pt; border-radius:25px; padding:10%;">
                    <i class="fas fa-marker"></i>
                </button>
                <br><br>
                <button class="btn btn-outline-danger" style="font-size: 20pt; border-radius:25px; padding:10%;">
                    <i class="fas fa-trash"></i>
                </button>
                <br><br>
                <button class="btn btn-outline-warning" style="font-size: 20pt; border-radius:25px; padding:10%;">
