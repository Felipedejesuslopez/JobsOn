...
$postu = new usuariopostulante($_GET['ir'], null, null, null, null, null, null, null, null, null, null, null, null, null, null);
...
<div class="chat">
    ...
    while ($msj = $msjs->fetch_array()) {
        if ($_SESSION['ID'] == $msj['ID_EMISOR'] && $msj['ROL_EMISOR'] == 'reclutador') {
            $clase = "message-sent";
        } else {
    ...
    ?>
        <div class="<?php echo $clase; ?>">
            ...
            <p><?php echo date('H:i',strtotime($msj['HORA'])); ?></p>
        </div>
    <?php
    }
    ?>
